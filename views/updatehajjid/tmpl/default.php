...
<table class="allhajjs table table-condensed table-bordered">
  ...
  <?php foreach ($hajjs as $key => $hajj): ?>
    <tr>
      <td><a href="index.php?option=com_hajj&view=UpdateHajjId&Itemid=312&id=<?php echo $hajj->id ?>"><?php echo $hajj->id ?></a></td>
      ...
      <td><a href="index.php?option=com_hajj&view=UpdateHajjId&id=<?php echo $hajj->id ?>" class="btn btn-success">تحديث</a></td>
    </tr>
  <?php endforeach ?>
</table>
