...
class HajjFieldHelper {
    ...
    public static $status_hajjs     = array("تحت التدقيق والمراجعة", "مقبول", "مرفوض", "تم الدفع", "الغاء الحجز", "الرفع للوزارة", "تصريح", "تسكين");
...
*/
  public static function getListHajjId($active = ""){
    ...
    $where        = 'addon = 0 AND (register_status = 2 OR register_status = 4)';
