  ...
  public function setEditHajj(){
    ...
    if ($obj->register_status == "") {// Not Admin
      ...
      switch ($obj->register_status) {  // Switch to send SMS
        ...
        case '4':
          // tama daf3
          // تم استلام المبلغ وبناء عليه تم اعتماد تسجيلكم في الشركة لحج هذا العام وستصلكم رسالة حين اعتماد العقد من الوزارة. فضلا راجع بريدك الإلكتروني للاطلاع على سند القبض.
          $obj->sms4 = "تم استلام المبلغ وبناء عليه تم اعتماد تسجيلكم في الشركة لحج هذا العام وستصلكم رسالة حين اعتماد العقد من الوزارة. فضلا راجع بريدك الإلكتروني للاطلاع على سند القبض.";
          $msgcode = "";
          break;
        
        case '6':
          // تصريح Tasrih
          // أخي الحاج نأمل منكم رفع المستندات المطلوبة عن طريق خدماتنا الإلكترونية. لمعرفة المستندات المطلوبة فضلا راجع خدمات التسجيل.
          $obj->sms6 = "أخي الحاج نأمل منكم رفع المستندات المطلوبة عن طريق خدماتنا الإلكترونية. لمعرفة المستندات المطلوبة فضلا راجع خدمات التسجيل. ";
          $msgcode = "";
          break;
