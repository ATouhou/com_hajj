    ...
    if (is_null($obj->register_status)) {// Not Admin
      ...
      switch ($obj->register_status) {  // Switch to send SMS
        case '2':
          ...
          $msg = "";
          break;
        
        case '3':
          // Refused
          // نعتذر عن قبول طلبكم 
          $msg = "06460639062A06300631002006390646002006420628064806440020063706440628064306450020000A";
          break;
        
        case '4':
          // تم الدفع tama daf3
          // تم اعتماد تسجيلكم في الشركة لحج هذا العام وستصلكم رسالة حين اعتماد العقد من الوزارة
          $msg = "";
          break;
        
        case '5':
          // الغاء الحجز ilgha el hajz
          // تم إلغاء الحجز
          $msg = "062A0645002006250644063A06270621002006270644062D062C0632000A";
          break;
